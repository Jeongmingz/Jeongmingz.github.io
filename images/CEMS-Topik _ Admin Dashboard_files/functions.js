...
{
    document.getElementById("dashboardIFrame").src = "./dashboard/"+url;
    $('#'+url).addClass('active').siblings().removeClass('active');

}

$('#dashboardmenu a').click(function(){
...
$(function(){
	...
	$("#checkpw").attr("disabled", "disabled");      	
    ...
    $("#checkpw").keyup(function(){
        ...
        if(pwd1 != ""){
            ...
            if(pwd1 == pwd2){
                $("#pwcorrect").show();
                $("#pwuncorrect").hide();
                $("#correctdiv").css({ //이렇게도 쓸 수 있으며 제일 낫다
